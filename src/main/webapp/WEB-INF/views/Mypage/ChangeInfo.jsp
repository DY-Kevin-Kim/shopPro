...
<div class="w3-main" style="margin-left:300px">  
  ...
  <div class="w3-container w3-padding-large w3-grey">
    <h4><b>내 정보 수정</b></h4>
    <form action="/shopPro/Updatefinish" target="_blank">
      <div class="w3-section">
        <label>아이디 변경</label>
        <input class="w3-input w3-border" type="text" name="changeid" placeholder="새로운 아이디를 입력하세요" required>
      </div>
      <div class="w3-section">
        <label>비밀번호 변경</label>
        <input class="w3-input w3-border" type="text" name="changePS" placeholder="새로운 비밀번호를 입력하세요" required>
      </div>
      <div class="w3-section">
        <label>배송지 변경</label>
        <input class="w3-input w3-border" type="text" name="changeAddress" placeholder="새로운 배송지를 입력하세요" required>
      </div>
      <button type="submit" class="w3-button w3-black w3-margin-bottom">바꾸기</button>
    </form>
  </div>
