...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <img src="/w3images/logo.jpg" style="width:45%;" class="w3-round"><br><br>
  </div>
...
<div class="w3-main" style="margin-left:300px">  
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <div id="right" class="w3-section w3-bottombar w3-padding-16" style="text-align: right">
      <button class="w3-button w3-white w3-hide-small">로그인</button>
      <button class="w3-button w3-white w3-hide-small">회원가입</button>
    </div>
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-third w3-margin-bottom">
        <ul class="w3-ul w3-border w3-white w3-center w3-opacity w3-hover-opacity-off">
          <li class="w3-padding-16"><img src="/shopPro/image/product.jpg"/></li>
